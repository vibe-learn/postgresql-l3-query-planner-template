"""Tests for the `l3_query_planner` homework scaffold.
...
def test_integration():
    """Интеграция: подключиться к реальному PostgreSQL и проверить логику урока «Query planner, EXPLAIN ANALYZE и pg_stat_statements»."""
